    ...
    >
      ...
      <div className="relative pt-6 px-4 z-10 flex justify-center gap-6 items-center">
        ...
        <a 
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center w-14 h-14 rounded-lg hover:opacity-80 transition-all duration-300"
        ...
        <div className="container mx-auto max-w-5xl relative z-10">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-6 md:gap-10">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="mt-6 px-2 py-0.5 bg-cyan-200 rounded-lg border border-cyan-300">
                <p className="text-2xl font-bold text-black">
                  Subzero
                </p>
              </div>
