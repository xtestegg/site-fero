          ...
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <div className="flex gap-4 justify-center mb-8">
                <a
                  ...
                  className="flex items-center justify-center w-16 h-16 rounded-full border-2 bg-gradient-to-br from-purple-500 to-pink-500 hover:shadow-lg hover:shadow-purple-500/50 transition-all duration-300"
                  style={{ borderColor: "rgba(168, 85, 247, 0.8)" }}
                  title="Join Discord"
                >
                  <svg className="w-8 h-8 text-lime-300" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center w-16 h-16 rounded-full border-2 bg-gradient-to-br from-cyan-500 to-blue-500 hover:shadow-lg hover:shadow-cyan-500/50 transition-all duration-300"
                  style={{ borderColor: "rgba(34, 211, 238, 0.8)" }}
                  title="Follow on X"
                >
                  <svg className="w-8 h-8 text-lime-300" fill="currentColor" viewBox="0 0 24 24">
