  ...
  return (
    ...
    >
      ...
      <header className="relative z-20 border-b-2 border-black p-6 flex justify-between items-center">
        ...
        <h1 className="text-4xl md:text-5xl font-black px-6 py-3 rounded-lg" style={{ letterSpacing: "0.15em", color: "#fff", background: "linear-gradient(135deg, rgba(92, 64, 51, 0.9) 0%, rgba(76, 110, 71, 0.9) 100%)", border: "3px solid #3d2f25", boxShadow: "0 0 20px rgba(139, 69, 19, 0.5)" }}>
          LORE GALLERY
        </h1>
      ...
      <div className="relative z-10 max-w-6xl mx-auto py-12 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="relative w-full aspect-square">
              <img
                ...
                style={{
                  ...
                  boxShadow: "inset 0 0 10px rgba(0,0,0,0.5), 0 0 30px rgba(0, 0, 0, 0.6), 0 0 60px rgba(0,0,0,0.8)"
                }}
              />
          ...
          {/* Info Side */}
          <div className="flex flex-col justify-center gap-6 p-8 rounded-lg relative" style={{
            background: "linear-gradient(135deg, rgba(92, 64, 51, 0.8) 0%, rgba(76, 110, 71, 0.8) 100%)",
            border: "4px solid #3d2f25",
            boxShadow: "inset 0 0 30px rgba(0, 0, 0, 0.6), 0 0 30px rgba(139, 69, 19, 0.4)"
          }}>
            <div>
            ...
            <div className="flex gap-4 mt-8">
              <button
                ...
                className="flex-1 px-6 py-3 rounded-lg border-2 border-cyan-400 text-white hover:bg-cyan-400 hover:text-black transition-all duration-300 flex items-center justify-center gap-2 font-bold"
              >
                ← PREV
              </button>
              <button
